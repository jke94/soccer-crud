...
{
    /// <inheritdoc />
    public partial class AddNewTablesAndRelations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamAway", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeamAway_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamHome", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeamHome_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    GoalMinute = table.Column<int>(type: "INTEGER", nullable: false),
                    MatchId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamAway_TeamId",
                table: "TeamAway",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamHome_TeamId",
                table: "TeamHome",
                column: "TeamId");
